...
final class feedbackController extends AbstractController
{
    ...
    public function index(FeedbackRepository $feedbackRepo,RequestStack $requestStack, EntityManagerInterface $em): Response
    {
    ...
    public function addFeedback(Request $request, EntityManagerInterface $em, GeminiModerationService $moderator,RequestStack $requestStack): Response
    {
        $session = $requestStack->getSession();
        $user    = $this->getCustomUser($em, $session);
    ...
    public function createReply(int $feedbackId, Request $request, EntityManagerInterface $entityManager,RequestStack $requestStack): Response
    {
        $session = $requestStack->getSession();
        $user    = $this->getCustomUser($entityManager, $session);
