...
class __TwigTemplate_456028753ae5634bdd0a0ee6c3098881 extends Template
{
...
";
    ...
    <div class=\"container-fluid px-0 mb-5\">
        ...
        yield "\">
            ...
            <div class=\"col-12 col-md-4 bg-light p-3 p-md-4 d-flex flex-column\">
                <div class=\"mb-auto\">
                    <h1 class=\"fw-bold mb-2 mb-md-3\">";
        // line 23
        ...
        yield " TND</h3>
                        ...
                        <button class=\"btn btn-primary px-4 py-2 rounded-pill fw-bold w-100 w-md-auto\">
    ...
    <div class=\"container\">
            ...
            <div class=\"col-12 col-lg-8 mb-4 mb-lg-0\">
                ...
                <div class=\"card border-0 shadow-sm rounded-3 mb-4\">
                    <div class=\"card-body p-3 p-md-4\">
                        <h2 class=\"fw-bold mb-3 mb-md-4\">About This Event</h2>
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["programmes"]) || array_key_exists("programmes", $context) ? $context["programmes"] : (function () { throw new RuntimeError('Variable "programmes" does not exist.', 97, $this->source); })())) > 0)) {
            ...
            yield "                <div class=\"card border-0 shadow-sm rounded-3 mb-4\">
                    <div class=\"card-body p-3 p-md-4\">
                        <h2 class=\"fw-bold mb-3 mb-md-4\">Event Program</h2>
                        <div class=\"timeline\">
                            ";
            // line 102
        ...
        yield "                
                ...
                <div class=\"card border-0 shadow-sm rounded-3 mb-4\">
                    <div class=\"card-body p-3 p-md-4\">
                        <h4 class=\"fw-bold mb-3 mb-md-4\">Event Details</h4>
...
{% block body %}
    ...
    <div class=\"container-fluid px-0 mb-5\">
        <div class=\"row g-0\">
            ...
            <div class=\"col-12 col-md-4 bg-light p-3 p-md-4 d-flex flex-column\">
                <div class=\"mb-auto\">
                    <h1 class=\"fw-bold mb-2 mb-md-3\">{{ event.titre }}</h1>
            ...
            <div class=\"col-12 col-lg-4\">
                ...
                <div class=\"card border-0 shadow-sm rounded-3 mb-4\">
                    <div class=\"card-body p-0\">
                        ...
                        <div class=\"p-3 p-md-4\">
                            <h4 class=\"fw-bold mb-2 mb-md-3\">{{ event.espace.nom }}</h4>
                            <p class=\"text-muted mb-0\">
                                <i class=\"fas fa-map-marker-alt text-primary me-2\"></i> 
...
{% endblock %}", "Front/aboutEvent.html.twig", "C:\\Users\\walid\\Downloads\\eventopia (1)\\eventopia\\eventopia\\templates\\Front\\aboutEvent.html.twig");
    }
}
